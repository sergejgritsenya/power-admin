...
import { ApplyRemoveDialog, ButtonLink } from "../common"
import { TAdminList } from "./types"

type TAdminListProps = {
  deleteOne: (admin_id: string) => void
  is_super: boolean
  list: TAdminList
}
export const AdminList: FC<TAdminListProps> = ({ list, deleteOne, is_super }) => {
  return (
    <Card>
      <CardContent>
        ...
        <AdminListTable list={list} deleteAdmin={deleteOne} is_super={is_super} />
      </CardContent>
    </Card>
  )
}
...
export const AdminListTable: FC<TAdminListTableProps> = ({
  list,
  deleteAdmin,
  is_super,
}) => (
